...
<form action="" method="post" class="form-horizontal">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
        <input type="text" value="<?php echo($refugio[$id-1]['ubicacion'])?>" class="form-control form-control-sm"  id="raza" 
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
        <input type="text" value="<?php echo($refugio[$id-1]['telefono'])?>" class="form-control form-control-sm"  id="edad" 
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
        <input type="text" value="<?php echo($refugio[$id-1]['horarios'])?>" class="form-control form-control-sm"  id="edad"
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
        <input value="<?php echo($refugio[$id-1]['mascotas']);?>" class="form-control form-control-sm"  
